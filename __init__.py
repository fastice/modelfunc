__all__ = ['argusMesh', 'argusToFiredrakeMesh', 'firedrakeSmooth', 
           'flotationHeight', 'flotationMask', 'getCheckPointVars',
           ...
           'schoofFriction', 'setupMesh', 'viscosity',
           'weertmanFriction']
...
from modelfunc.slidingAndViscosity import viscosity
